...
class NSmoothedPowerlawMSmoothedGaussianSage(
    NSmoothedPowerlawMSmoothedGaussianCore, Sage
):
    def __init__(
        self,
        N_pl: int,
        ...
        NSmoothedPowerlawMSmoothedGaussianCore.__init__(
            self,
            N_pl=N_pl,
            N_g=N_g,
...
class NSmoothedPowerlawMSmoothedGaussianFSage(
    NSmoothedPowerlawMSmoothedGaussianSage, FlowMCBased
):
    pass


class NSmoothedPowerlawMSmoothedGaussianNSage(
    NSmoothedPowerlawMSmoothedGaussianSage, NumpyroBased
):
    pass
