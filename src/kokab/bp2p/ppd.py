...
def BrokenPowerlawTwoPeakFull_raw(
    use_spin: bool = False,
...
def model(raw: bool, **params) -> DistributionLike:
    ...
    _model = BrokenPowerlawTwoPeakFull_raw if raw else BrokenPowerlawTwoPeakFull
...
def main() -> None:
    ...
    parameters = [P.PRIMARY_MASS_SOURCE.value]
    if args.raw:
        parameters.append(P.MASS_RATIO.value)
    else:
        parameters.append(P.SECONDARY_MASS_SOURCE.value)
