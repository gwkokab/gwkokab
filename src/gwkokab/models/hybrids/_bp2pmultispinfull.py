...
class BrokenPowerlawTwoPeakMultiSpinMultiTilt(Distribution):
    arg_constraints = {
        ...
        "a_1_low_bpl1": constraints.unit_interval,
        "a_1_low_bpl2": constraints.unit_interval,
        "a_1_low_n1": constraints.unit_interval,
        "a_1_low_n2": constraints.unit_interval,
        "a_2_low_bpl1": constraints.unit_interval,
        "a_2_low_bpl2": constraints.unit_interval,
        "a_2_low_n1": constraints.unit_interval,
        "a_2_low_n2": constraints.unit_interval,
        "a_1_high_bpl1": constraints.unit_interval,
        "a_1_high_bpl2": constraints.unit_interval,
        "a_1_high_n1": constraints.unit_interval,
        "a_1_high_n2": constraints.unit_interval,
        "a_2_high_bpl1": constraints.unit_interval,
        "a_2_high_bpl2": constraints.unit_interval,
        "a_2_high_n1": constraints.unit_interval,
        "a_2_high_n2": constraints.unit_interval,
    ...
    def __init__(
        ...
        mmax: ArrayLike,
        mbreak: ArrayLike,
        a_1_low_bpl1: ArrayLike,
        a_1_low_bpl2: ArrayLike,
        a_1_low_n1: ArrayLike,
        a_1_low_n2: ArrayLike,
        a_2_low_bpl1: ArrayLike,
        a_2_low_bpl2: ArrayLike,
        a_2_low_n1: ArrayLike,
        a_2_low_n2: ArrayLike,
        a_1_high_bpl1: ArrayLike,
        a_1_high_bpl2: ArrayLike,
        a_1_high_n1: ArrayLike,
        a_1_high_n2: ArrayLike,
        a_2_high_bpl1: ArrayLike,
        a_2_high_bpl2: ArrayLike,
        a_2_high_n1: ArrayLike,
        a_2_high_n2: ArrayLike,
        ...
        batch_shape = lax.broadcast_shapes(
            ...
            jnp.shape(mmax),
            jnp.shape(mbreak),
            jnp.shape(a_1_high_bpl1),
            jnp.shape(a_1_high_bpl2),
            jnp.shape(a_1_high_n1),
            jnp.shape(a_1_high_n2),
            jnp.shape(a_2_high_bpl1),
            jnp.shape(a_2_high_bpl2),
            jnp.shape(a_2_high_n1),
            jnp.shape(a_2_high_n2),
            jnp.shape(a_1_low_bpl1),
            jnp.shape(a_1_low_bpl2),
            jnp.shape(a_1_low_n1),
            jnp.shape(a_1_low_n2),
            jnp.shape(a_2_low_bpl1),
            jnp.shape(a_2_low_bpl2),
            jnp.shape(a_2_low_n1),
            jnp.shape(a_2_low_n2),
    ...
    def _log_prob_a1_components(self, a1: ArrayLike) -> ArrayLike:
        comp_bpl1 = truncnorm_logpdf(
            ...
            low=self.a_1_low_bpl1,
            high=self.a_1_high_bpl1,
        )
        comp_bpl2 = truncnorm_logpdf(
            a1,
            loc=self.a_1_loc_bpl2,
            scale=self.a_1_scale_bpl2,
            low=self.a_1_low_bpl2,
            high=self.a_1_high_bpl2,
        )
    ...
    def _log_prob_a2_components(self, a2: ArrayLike) -> ArrayLike:
        comp_bpl1 = truncnorm_logpdf(
            ...
            low=self.a_2_low_bpl1,
            high=self.a_2_high_bpl1,
        )
        comp_bpl2 = truncnorm_logpdf(
            a2,
            loc=self.a_2_loc_bpl2,
            scale=self.a_2_scale_bpl2,
            low=self.a_2_low_bpl2,
            high=self.a_2_high_bpl2,
        )
        comp_n1 = truncnorm_logpdf(
            a2,
            loc=self.a_2_loc_n1,
...
def BrokenPowerlawTwoPeakMultiSpinMultiTiltFull(
    ...
    **params: Array,
    ...
    smoothing_model = BrokenPowerlawTwoPeakMultiSpinMultiTilt(
        ...
        a_1_low_bpl1=params["a_1_low_bpl1"],
        a_1_low_bpl2=params["a_1_low_bpl2"],
        a_1_low_n1=params["a_1_low_n1"],
        a_1_low_n2=params["a_1_low_n2"],
        a_2_low_bpl1=params["a_2_low_bpl1"],
        a_2_low_bpl2=params["a_2_low_bpl2"],
        a_2_low_n1=params["a_2_low_n1"],
        a_2_low_n2=params["a_2_low_n2"],
        a_1_high_bpl1=params["a_1_high_bpl1"],
        a_1_high_bpl2=params["a_1_high_bpl2"],
        a_1_high_n1=params["a_1_high_n1"],
        a_1_high_n2=params["a_1_high_n2"],
        a_2_high_bpl1=params["a_2_high_bpl1"],
        a_2_high_bpl2=params["a_2_high_bpl2"],
        a_2_high_n1=params["a_2_high_n1"],
        a_2_high_n2=params["a_2_high_n2"],
