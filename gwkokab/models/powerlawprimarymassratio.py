...
class PowerLawPrimaryMassRatio(Distribution):
    ...
    .. math::
        \begin{align*}
            ...
            p(q | m_1, \beta) & \propto q^{\beta}, \qquad \frac{m_1}{m_{\text{min}}} \leq q \leq 1
        \end{align*}
    """
    ...
    def __init__(
        ...
        *,
        ...
        super(PowerLawPrimaryMassRatio, self).__init__(batch_shape=batch_shape, validate_args=validate_args)
