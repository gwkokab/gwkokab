...
def linkcode_resolve(domain, info):
    ...
    if "+" in gwkokab.__version__:
        return (
            f"https://github.com/kokabsc/gwkokab/blob/HEAD/src/gwkokab/{fn}{linespec}"
        )
    else:
        return f"https://github.com/kokabsc/gwkokab/blob/v{gwkokab.__version__}/src/gwkokab/{fn}{linespec}"
...
intersphinx_mapping = {
    ...
    "gwpopulation_pipe": (
        "https://docs.ligo.org/RatesAndPopulations/gwpopulation_pipe/",
        None,
    ),
}
