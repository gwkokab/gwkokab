...
CONTINUOUS = [
    ...
    (
        NPowerLawMGaussian,
        {
            ...
            "mmax_0": 70.0,
            "use_tilt": True,
            "std_dev_tilt1_pl_0": 0.1,
            "std_dev_tilt2_pl_0": 0.1,
        },
    ),
    (
        NPowerLawMGaussian,
        {
            ...
            "scale_m2_0": 3.2,
            "use_tilt": True,
            "std_dev_tilt1_g_0": 0.1,
            "std_dev_tilt2_g_0": 0.1,
        },
    ),
    (
        NPowerLawMGaussian,
        {
            ...
            "std_dev_tilt1_g_0": 0.1,
            "std_dev_tilt1_pl_0": 0.1,
            "std_dev_tilt2_g_0": 0.3,
            "std_dev_tilt2_pl_0": 0.2,
        },
    ),
    (
        NPowerLawMGaussian,
        {
            ...
            "use_tilt": True,
            "std_dev_tilt1_g_0": 0.1,
            "std_dev_tilt1_g_1": 0.3,
            "std_dev_tilt1_pl_0": 0.1,
            "std_dev_tilt2_g_0": 0.1,
            "std_dev_tilt2_g_1": 0.3,
            "std_dev_tilt2_pl_0": 0.1,
        },
    ),
    (
    ...
    ######### NPowerLawMGaussian_TruncatedNormalEccentricity (m1, m2) #########
    (
        NPowerLawMGaussian_TruncatedNormalEccentricity,
        {
            "N_pl": 1,
    ...
    ######### NPowerLawMGaussian_TruncatedNormalEccentricity (m1, m2, chi1, chi2) #########
    (
        NPowerLawMGaussian_TruncatedNormalEccentricity,
        {
            "N_pl": 1,
    ...
    ######### NPowerLawMGaussian_TruncatedNormalEccentricity (m1, m2, cos_tilt_1, cos_tilt_2) #########
    (
        NPowerLawMGaussian_TruncatedNormalEccentricity,
        {
            "N_pl": 1,
    ...
    ######### NPowerLawMGaussian_TruncatedNormalEccentricity (m1, m2, ecc) #########
    (
        NPowerLawMGaussian_TruncatedNormalEccentricity,
        {
            "N_pl": 1,
    ...
    ######### NPowerLawMGaussian_TruncatedNormalEccentricity (m1, m2, chi1, chi2, cos_tilt_1, cos_tilt_2, ecc) #########
    (
        NPowerLawMGaussian_TruncatedNormalEccentricity,
        {
            "N_pl": 1,
...
def test_log_prob_gradient(jax_dist, params):
    ...
    for i, k in enumerate(params.keys()):
        ...
        if jax_dist is Wysocki2019MassModel and i != 0:
            continue
        if (
            jax_dist is NPowerLawMGaussian
            or jax_dist is NPowerLawMGaussian_TruncatedNormalEccentricity
        ) and any([k.startswith("mmin"), k.startswith("mmax")]):
            continue
